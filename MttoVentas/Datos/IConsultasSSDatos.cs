...
namespace MttoVentas.Datos
{
    public interface IConsultasSSDatos
    {
        ...
        void refoliar(List<long> folios, string estacion, List<long> refolios, string nvoFolio, string serie);
        ...
        bool cambiaFolioFacturados(string serie, List<long> foliosFact, string estacion, long ultimoFolio);
    }
}
