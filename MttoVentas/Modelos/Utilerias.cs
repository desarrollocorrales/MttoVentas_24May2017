...
namespace MttoVentas.Modelos
{
    ...
    {
        public static string connSS { get; set; }
        public static string connMySQL { get; set; }
    }

    public static class Login
    {
        public static Dictionary<int, string> series;
    ...
    public class Utilerias
    {
        ...
        /// <param name="SqlQuery">sentencia sql a ejecutar</param>
        /// <returns>Estatus de transacción y datos obtenidos</returns> 
        public static ManejoSql_SS EjecutaSQL(string SqlQuery, SqlCommand cmd)
        {
            ManejoSql_SS result = new ManejoSql_SS();
        ...
        /// <param name="FilasAfectadas">Fila afectadas por la sentencia SQL</param>
        /// <returns></returns>
        public static ManejoSql_SS EjecutaSQL(string SqlQuery, ref int FilasAfectadas, SqlCommand cmd)
        {
            ManejoSql_SS result = new ManejoSql_SS();
